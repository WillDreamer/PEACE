...
class CosSim(nn.Module):
    ...
    def forward(self, x):
        """
        The function takes in a batch of feature vectors and returns the logits for each of the feature
        vectors. 
        
        The logits are the dot product of the feature vector and the centroid vector. 
        
        The centroid vector is the mean of all the feature vectors in the cluster. 
        
        The feature vector is normalized before the dot product is computed. 
        
        The centroid vector is also normalized before the dot product is computed. 
        
        The dot product is computed for each feature vector in the batch. 
        
        The dot product is computed for each centroid vector. 
        
        The dot product is computed for each feature vector and each centroid vector. 
        ...
        :return: The logits are the dot product of the normalized features and the normalized centroids.
        """
...
class ModelWrapper(nn.Module):
    ...
    def forward(self, x):
        """
        The function takes in an input image, passes it through the model, and returns the logit,
        feature, and hash code
        
        :param x: input data
        :return: The logit, feature, and y are being returned.
        """
