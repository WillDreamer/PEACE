...
def seed_torch(seed=2022):
    ...
    :param seed: the random seed to use, defaults to 2022 (optional)
    """
    random.seed(seed)
...
def run():
    """
    It loads the data, then trains the model, then evaluates the model
    """
    # Load configuration
    seed_torch()
    seed= 2022
...
def load_config():
    ...
    parser.add_argument('--source', type=str, default='Clipart.txt', help="The source dataset")
